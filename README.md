...
| **Frontend** | React, Next.js, Vite, SASS, CSS, Tailwind CSS, Radix UI, TansQuery, Redux Toolkit, Material UI |
| **Backend** | Node.js, Express, FastAPI, Flask |
| **Databases** | PostgreSQL, MySQL, Redis, Firebase, Supabase, Prisma, Sequelize, |
...
| **Infra** | Docker, AWS, Digital Ocean, Vercel, Railway, PM2, Prometheus, Grafana, Sentry |

---

### What I've Built

**[Rebucom](https://rebucom.com)** &mdash; Delivery management platform. Led engineering team and delivery backend API with 36+ modules, 4 frontends products (admin dashboard, merchant portal, customer app, driver PWA) and a website.
...
**[VitalSwap](https://vitalwap.com)** &mdash; Fintech platform with checkout flow, business dashboard, business and personal marketing site. React + Tanstack Query + Radix UI.
